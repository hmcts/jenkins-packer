...
export HELM_VERSION=$(echo v3.17.0 | tr -d 'v')
...
export TF_VERSION=$(echo v1.10.4 | tr -d 'v')
...
export ZAP_VERSION=$(echo v2.16.0 | tr -d 'v')
...
CHROME_DEVEL_SANDBOX="/opt/jenkins/workspace/Sandbox_cnp-plum-frontend_master/.yarn/unplugged/puppeteer-npm-9.1.1-e9a012ddd7/node_modules/puppeteer/.local-chromium/linux-869685/chrome-linux/chrome_sandbox"
